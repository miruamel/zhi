...
- **Audit-log stale fact sweep** — 3 historical entries (`ci-green-all-runs.md`, `state-sync-8.md`, `rebase-completion.md`) carried outdated audit counts (78/80 instead of 82). Fixed: `ci-green-all-runs.md` 4 lines "78 entries" → 82; `state-sync-8.md` line 41 "78 entries" → 82; `rebase-completion.md` verification table "80" → 82 and "74→78" → "78→82". New entry `2026-09-05-stale-fact-sweep.md` documents the sweep. Audit-log now 83/83 consistent (disk = 83, README = 83, header = 83).
