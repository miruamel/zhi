...
- `assets/` — `favicon.svg` (64×64), `logo.svg` (360×96), `og-banner.svg` (1200×630), `banner.txt` (ASCII splash), `assets/README.md` (asset index).
...
- `docs/marketing/` — `landing-copy.md` (hero/problem/how-it-works/features/FAQ for zhi.dev), `social-bio.md` (GitHub/X/LinkedIn/npm bios), `use-cases.md` (8 concrete user stories), `repo-metadata.md` (checklist of forgotten small details).
...
- README translated to English, with badge grid (CI / License / Maturity / Bun / Node ≥ 20).
