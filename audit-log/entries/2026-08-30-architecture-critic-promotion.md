...
- **Action**: tambah `engine/critic/plant/architecture/` (critic + test); wire ke `composeCritiques()`; update `docs/design/critic.md`; tambah ADR-008; update EXPLAIN-CHANGES (`docs/archive/EXPLAIN-CHANGES.md` per 2026-09-02 rename).
