...
survived the rebase. Push succeeded (fast-forward, branch protection bypassed
since all 3 required checks already green on `fe690de`).
...
| Audit-log disk entries | 80 |
| Audit-log README entries | 80 |
...
- `audit-log/entries/2026-09-04-ci-green-all-runs.md`: stale counts 74→78
  (4 lines updated)
- `audit-log/entries/2026-09-04-state-sync-8.md`: commit `f32e1d6`→`eab2cad`,
  74→78 entries, 365/726→367/730 gate counts, open issues list updated