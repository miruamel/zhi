...
/** @brief Architect agent — designs system architecture. @since 0.1.11 */
...
/** @brief Coder agent — writes implementation code. @since 0.1.11 */
...
/** @brief Critic agent — runs quality checks. @since 0.1.11 */
...
/** @brief Research agent — investigates topics. @since 0.1.11 */
...
/** @brief DevOps agent — manages builds and releases. @since 0.1.11 */
...
/** @brief All built-in agent definitions. @since 0.1.11 */
