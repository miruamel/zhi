/** @brief Critic: cyclomatic complexity — count branches per function. @since 0.1.10 */
import type { CriticResult } from '../../aggregate';
import type { FileRecord } from '../sloc/critic';

/** @brief Max complexity before penalty. @since 0.1.10 */
const MAX_COMPLEXITY = 10;
/** @brief Penalty per point over limit. @since 0.1.10 */
const PENALTY_PER_POINT = 0.02;

/** @brief Count cyclomatic complexity of a function body. @since 0.1.10 */
...
/** @brief Extract function bodies from source. @since 0.1.10 */
