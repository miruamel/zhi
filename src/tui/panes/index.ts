/** @brief Panes barrel — re-exports all pane components. @since 0.1.2 @updated 0.2.0 */
export { Header } from './top/header/header';
export { Dag } from './top/dag/dag';
export { Detail } from './top/detail/detail';
export { CodeViewer } from './top/code-viewer/code-viewer';
...
export { AgentsPane } from './middle/agents/agents';
