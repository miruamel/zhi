  ...
  if (!showHelp) {
    return (
      <Box paddingX={1} gap={1}>
        ...
        <Text color={colors.fg}>q</Text><Text color={colors.fgDim}>uit</Text>
        <Text color={colors.fgDim}> · </Text>
        <Text color={colors.fg}>space</Text><Text color={colors.fgDim}>pause</Text>
        <Text color={colors.fgDim}> · </Text>
        <Text color={colors.fg}>l/c/p/h</Text><Text color={colors.fgDim}>panels</Text>
        <Text color={colors.fgDim}> · </Text>
        <Text color={colors.fg}>?</Text><Text color={colors.fgDim}>help</Text>
        {paused && <Text color={colors.warn} bold> · PAUSED</Text>}
      </Box>
    );
  }
  return (
    <Box flexDirection="column" borderStyle="round" borderColor={colors.accent} paddingX={1}>
      <Text color={colors.accent} bold>⌨  KEYBINDINGS</Text>
      ...
      {paused && <Text color={colors.warn} bold>⏸  PAUSED — press space to resume</Text>}
    </Box>
  );
}
